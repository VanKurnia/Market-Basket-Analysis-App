<form wire:submit.prevent="submitForm" action="#">
    ...
    <div class="grid gap-4 grid-cols-4 sm:grid-cols-4 sm:gap-6 mb-4">
        ...
        {{-- Price Filter --}}
        <div class="col-span-1">
            <label for="min-price" class="block mb-2 text-xl font-semibold text-gray-900 dark:text-white">
                Min Price
            </label>
            <div class="relative w-full">
                ...
                <input type="number" id="min-price" aria-describedby="helper-text-explanation" wire:model='minPrice'
                    class="bg-gray-50 border ps-10 border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Harga Minimal"oninput="formatCurrency(this)" />
            </div>
        </div>

        <div class="col-span-1">
            <label for="max-price" class="block mb-2 text-xl font-semibold text-gray-900 dark:text-white">
                Max Price
            </label>
            <div class="relative w-full">
                <div class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                ...
                <input type="number" id="max-price" aria-describedby="helper-text-explanation" wire:model='maxPrice'
                    class="bg-gray-50 border ps-10 border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Harga Maximal" oninput="formatCurrency(this)" />
            </div>
        </div>
    </div>
