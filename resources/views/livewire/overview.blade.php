    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                Optimize Your Retail Strategy with Data-Driven Insights!
            </h2>
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">
                Temukan pola pembelian pelanggan dengan analisis cerdas yang membantu Anda meningkatkan penjualan dan
                mengoptimalkan penempatan produk secara efektif.
            </p>
        </div>
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">
                    Pola Pembelian Cerdas
                </h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Identifikasi pola pembelian pelanggan dengan cepat dan
                    dapatkan rekomendasi produk yang relevan.
                </p>
            </div>
            <div>
                <div
                    ...
                    <svg class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
                        ...
                        <path fill-rule="evenodd" d="M2 13H8V21H2V13ZM9 3H15V21H9V3ZM16 8H22V21H16V8Z"
                            clip-rule="evenodd"></path>
                    </svg>
                </div>
                <h3 class="mb-2 text-xl font-bold dark:text-white">Analisis Produk Terlaris</h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Pantau produk yang paling diminati dan tingkatkan stok untuk menghindari kekurangan barang.
                </p>
            </div>
            <div>
                <div
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Rekomendasi Bundle</h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Buat bundle produk yang menarik untuk meningkatkan penjualan dan memberikan penawaran menarik bagi
                    pelanggan.
                </p>
            </div>
            <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Pengaturan Tata Letak Produk</h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Optimalkan tata letak produk di toko Anda berdasarkan analisis pola belanja pelanggan.
                </p>
            </div>
            <div>
                <div
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Penentuan Diskon</h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Tentukan diskon yang paling tepat untuk meningkatkan loyalitas pelanggan dan volume penjualan.
                </p>
            </div>
            <div>
                <div
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Kinerja Produk</h3>
                <p class="text-gray-500 dark:text-gray-400">
                    Analisis performa setiap produk berdasarkan penjualan, tren, dan kontribusi terhadap pendapatan.
                </p>
            </div>
        </div>
    </div>
